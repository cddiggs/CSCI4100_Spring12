...
public class GUI_AllSolutionsHTML extends JFrame {
	...
	public GUI_AllSolutionsHTML() {
		...
		JLabel lblQuestionSelectionMethod = new JLabel("Adding All Solutions");
		...
		/**Generate button passes information in the frame to the function to create the desired HTML Solution Guide*/
